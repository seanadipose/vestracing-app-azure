...
App.Config = App.Config || {
	defaults: function () {
		return {
			...
			moduleEvents: ['initialized', 'rendered', 'dataBound', 'pageLoaded', 'saved'],
			...
			events: {
				...
				saved: [{
					callback: function (e, status, xhr) {
						...
						console.log('saved callback invoked');
		...
		schema: {
			model: {
				...
				fields: {
					...
					ProviderID: { field: '_provider_id', editable: false },
					Price: { field: '_price' },
					Message: { field: '_message' },
					DeliveryMin: { field: '_delivery_min' },
					DeliveryMax: { field: '_delivery_max' },
					DeliveryUnit: { field: '_delivery_unit' },
					Network: { field: '_requires_network' },
					Mobile: { field: '_requires_mobile' },
					Provider: { field: '_requires_provider' },
					PIN: { field: '_requires_pin' },
					KBH: { field: '_requires_kbh' },
					MEP: { field: '_requires_mep' },
					PRD: { field: '_requires_prd' },
					SN: { field: '_requires_sn' },
					SecRO: { field: '_requires_sec_RO' },
					Reference: { field: '_requires_reference' },
					ServiceTag: { field: '_requires_service_tag' },
					ICloudEmail: { field: '_requires_i_cloud_email' },
					ICloudPhone: { field: '_requires_i_cloud_phone' },
					Type: { field: '_requires_type' },
					Locks: { field: '_requires_locks' }
				}
			}
		}
	},
		...
		schema: {
			model: {
				...
				fields: {
					Name: { field: '_name' },
					ID: { field: 'id', editable: false },
					ReferenceNo: { field: '_provider_id', editable: false },
					Date: { field: '_date' },
					Delivery: { field: '_delivery' },
					Credits: { field: '_credits' },
					Mobile: { field: '_mobile' },
					Tool: { field: '_tool' },
				}
			}
		}
...
App.Config.Widgets = App.Config.Widgets || {
	defaults: function () {
		return {
			...
			mobilebuttongroup: {
				type: 'kendoMobileButtonGroup'
			},
			mobileswitch: {
				type: 'kendoMobileSwitch'
			}
		}
	}
};